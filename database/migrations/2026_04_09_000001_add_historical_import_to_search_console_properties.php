...
return new class extends Migration
{
    ...
    {
        Schema::table('search_console_properties', function (Blueprint $table) {
    ...
    {
        DB::statement('ALTER TABLE search_console_properties DROP CONSTRAINT IF EXISTS search_console_properties_historical_import_status_check');
